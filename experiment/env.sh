...
export SEARCH_R1_TRAIN_VENV="${SEARCH_R1_TRAIN_VENV:-/data/venvs/search-r1-stage02}"
export SEARCH_R1_STAGE02_CACHE="${SEARCH_R1_STAGE02_CACHE:-/data/cache/search-r1/experiments/02-tiny-grpo}"
